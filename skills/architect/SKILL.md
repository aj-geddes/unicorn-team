...
See `references/architecture-patterns.md` for detailed tradeoffs.
...
See `references/api-design-guide.md` for patterns.
...
- `references/architecture-patterns.md` — Pattern descriptions, tradeoffs, selection criteria
- `references/adr-examples.md` — Full ADR examples and real-world decision records
- `references/api-design-guide.md` — REST/GraphQL/gRPC design, versioning, error handling
- `references/data-modeling.md` — Schema design, normalization, migration patterns
- `references/scaling-strategies.md` — Horizontal/vertical scaling, caching, performance
