...
- `references/pattern-mapping.md` -- Full pattern equivalence tables across Python, Go, Rust, JS
- `references/language-profiles.md` -- Detailed language profiles (paradigm, ecosystem, gotchas)
- `references/workflow-examples.md` -- Complete learning, pattern transfer, and migration workflows
- `scripts/new-language.sh` -- Interactive 5-phase learning protocol script
