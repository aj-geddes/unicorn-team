...
See: `.claude/protocols/developer/references/debugging-protocols.md`
...
- `.claude/protocols/developer/references/tdd-examples.md` -- per-language TDD examples, mocking, property-based testing
- `.claude/protocols/developer/references/debugging-protocols.md` -- root-cause analysis, language-specific debuggers
- `.claude/protocols/developer/references/language-idioms.md` -- idiomatic patterns per language
- `.claude/protocols/developer/scripts/tdd.sh` -- interactive TDD workflow script
