...
See: `.claude/protocols/qa-security/references/code-review-layers.md` for detailed checklists
See: `.claude/protocols/qa-security/references/security-review-checklists.md` for STRIDE and threat modeling
...
See: `.claude/protocols/qa-security/references/report-templates.md` for full templates
...
See: `.claude/protocols/qa-security/references/security-review-checklists.md`
...
- `.claude/protocols/qa-security/references/security-review-checklists.md` -- STRIDE model, threat modeling steps, attack scenarios
- `.claude/protocols/qa-security/references/code-review-layers.md` -- detailed logic, design, and quality checks
- `.claude/protocols/qa-security/references/report-templates.md` -- full PASS/FAIL and security report templates
